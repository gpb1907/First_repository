...
INSERT INTO `admin` VALUES (1,'admin','123'),(2,'admin2','123'),(3,'Saddam','saddam1');
...
INSERT INTO `daily_receive` VALUES (5000,103,250,3,80,'S','2019-05-26',12),(5000,105,250,6,75,'L','2019-05-26',12),(5000,105,250,6,95,'M','2019-05-26',13),(6550,101,350,2,75,'S','2019-05-14',12),(5500,105,210,6,75,'M','2019-05-14',12),(5500,100,210,1,75,'XL','2019-05-10',12),(5025,100,275,1,75,'XL','2019-05-10',12),(5500,106,210,7,75,'L','2019-05-25',12),(5000,105,250,6,95,'M','2019-05-25',13),(6550,104,350,5,75,'XL','2019-05-15',12),(5000,100,250,5,75,'L','2019-05-24',12),(5000,106,250,5,75,'XL','2019-05-26',12),(5500,104,210,5,75,'S','2019-05-26',12),(5000,104,250,4,80,'M','2019-05-26',12),(5025,101,275,2,75,'L','2019-05-26',12);
...
INSERT INTO `daily_receive_linking` VALUES (1,107,5025,275,8,85,'L','2018-12-04',13),(2,106,5000,250,7,85,'M','2018-12-04',13),(3,107,5025,275,8,85,'L','2018-12-04',13),(4,108,6550,350,3,85,'XL','2018-12-04',19),(5,109,6550,350,4,85,'XL','2018-12-04',21),(6,106,5000,250,1,85,'S','2018-12-05',18),(7,107,5000,250,2,85,'M','2018-12-05',19),(8,108,5000,250,3,85,'L','2018-12-05',13),(9,107,5000,250,2,70,'S','2018-12-05',24),(10,109,5025,275,4,85,'L','2018-12-05',13),(11,110,6550,350,4,85,'XL','2018-12-05',22),(12,111,6550,350,5,85,'XL','2018-12-05',21),(13,112,5000,250,2,70,'M','2018-12-05',12),(14,107,5025,275,2,85,'L','2018-12-06',21),(15,108,5025,275,2,85,'L','2018-12-06',15),(16,109,6550,350,2,85,'XL','2018-12-06',16),(17,110,6550,350,4,85,'XL','2018-12-06',17),(18,111,5000,250,5,83,'XL','2018-12-06',18),(19,107,5000,250,1,70,'M','2018-12-06',14),(20,112,5000,250,6,70,'L','2019-03-26',12),(21,112,5000,250,6,70,'L','2019-03-26',12),(22,111,5000,250,5,75,'M','2019-03-26',15),(23,111,5000,250,5,75,'M','2019-03-26',15);
...
--
-- Table structure for table `login_finishing`
--

DROP TABLE IF EXISTS `login_finishing`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `login_finishing` (
...
--
-- Dumping data for table `login_finishing`
--

LOCK TABLES `login_finishing` WRITE;
/*!40000 ALTER TABLE `login_finishing` DISABLE KEYS */;
INSERT INTO `login_finishing` VALUES ('finishing','123');
/*!40000 ALTER TABLE `login_finishing` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `login_knitting`
--

DROP TABLE IF EXISTS `login_knitting`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `login_knitting` (
...
--
-- Dumping data for table `login_knitting`
--

LOCK TABLES `login_knitting` WRITE;
/*!40000 ALTER TABLE `login_knitting` DISABLE KEYS */;
INSERT INTO `login_knitting` VALUES ('knitting','123');
/*!40000 ALTER TABLE `login_knitting` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `login_linking`
--

DROP TABLE IF EXISTS `login_linking`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `login_linking` (
  `user_name` varchar(30) NOT NULL,
  `password` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`user_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `login_linking`
--

LOCK TABLES `login_linking` WRITE;
/*!40000 ALTER TABLE `login_linking` DISABLE KEYS */;
INSERT INTO `login_linking` VALUES ('linking','123');
/*!40000 ALTER TABLE `login_linking` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `login_washing`
--

DROP TABLE IF EXISTS `login_washing`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `login_washing` (
  `user_name` varchar(30) NOT NULL,
  `password` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`user_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `login_washing`
--

LOCK TABLES `login_washing` WRITE;
/*!40000 ALTER TABLE `login_washing` DISABLE KEYS */;
INSERT INTO `login_washing` VALUES ('washing','123');
/*!40000 ALTER TABLE `login_washing` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `order_knitting` VALUES (75,5025,102,275,3,75,'M','2019-05-26',12),(76,5025,103,275,4,75,'S','2019-05-26',12),(82,6550,102,350,3,75,'M','2019-05-26',12),(83,6550,103,350,4,75,'L','2019-05-26',12);
...
INSERT INTO `order_linking` VALUES (19,112,5000,250,6,75,'S','2018-12-05',15),(24,113,5500,250,7,80,'XL','2019-01-10',12),(25,113,5500,250,7,80,'XL','2019-01-10',12),(26,100,6550,250,0,85,'L','2019-01-10',12),(27,100,6550,250,0,85,'L','2019-01-10',12),(28,100,5500,250,5,80,'XL','2019-01-10',12),(29,107,5000,250,1,75,'L','2019-05-26',15);
...
INSERT INTO `order_list` VALUES (5000,250,'Imran','India',2321,2306,2296,2321,9244,2000,'2018-11-10','2018-11-10','Please complete the job Nov 30, 2018'),(5025,275,'Aman ullah','Pakistan',4904,4917,4892,4880,19605,5000,'2018-10-10','2018-10-10','Please complete the job Oct 30, 2018'),(5500,210,'Rayhan','America',4988,5988,5988,4988,21964,120000,'2019-01-01','2019-09-20','Please complete the job Oct 30, 2019'),(6550,350,'Fokrul Islam','Afganistan',12344,12356,12356,12356,49424,10000,'2018-07-01','2018-07-01','Please complete the job Sep 30, 2018');
...
INSERT INTO `paid_salary_knitting` VALUES (1,100,'Md. Saddam','Paid'),(3,101,'Md. Rana ','Paid'),(6,102,'Md. Imran','Paid'),(7,103,'Mst. Sanjida Akter','Paid'),(8,104,'Md. Asadul islam','Paid'),(12,106,'Md. Alamin prodhan','Paid');
...
INSERT INTO `salary_calculation_knitting` VALUES (100,89,80,7120,20,1424,8544),(104,81,95,7695,20,1539,9234),(106,61,60,3660,5,183,3843);
...
INSERT INTO `total_order_linking` VALUES (23,5000,250,75,'S',15,'Please complete the job\n Nov 30, 2018'),(24,5000,250,70,'M',15,'dkafja;dljf;'),(25,5025,275,75,'L',12,''),(26,5025,275,75,'M',12,''),(27,5000,250,70,'M',12,''),(28,5025,275,80,'L',18,''),(29,5000,250,83,'L',13,''),(30,5000,250,70,'XL',12,''),(31,5000,250,75,'M',10,''),(32,5025,275,83,'XL',12,''),(33,5025,275,70,'L',12,''),(34,6550,350,83,'M',16,''),(35,5000,250,83,'M',15,''),(36,5000,250,75,'M',10,''),(37,6550,350,83,'S',12,''),(38,6550,350,83,'L',14,''),(39,5000,250,83,'S',12,''),(40,5025,275,70,'XL',12,''),(41,5000,250,83,'M',16,''),(42,6550,350,83,'XL',15,''),(43,5000,250,75,'M',12,''),(44,5025,275,75,'S',12,''),(45,5025,275,90,'L',13,''),(46,5025,275,90,'L',13,''),(47,5025,275,90,'L',13,''),(48,5000,250,75,'S',12,''),(49,5000,250,70,'L',12,''),(50,5500,210,80,'XL',12,''),(51,5000,250,75,'M',12,''),(52,5000,250,75,'L',12,''),(53,6550,350,85,'L',12,''),(54,5025,275,95,'M',13,''),(55,5000,250,75,'M',15,''),(56,5000,250,80,'S',12,''),(57,5000,250,75,'L',12,''),(58,5000,250,95,'M',13,''),(59,6550,350,75,'S',12,''),(60,5500,210,75,'M',12,''),(61,5500,210,75,'XL',12,''),(62,5025,275,75,'XL',12,''),(63,5500,210,75,'L',12,''),(64,5000,250,95,'M',13,''),(65,6550,350,75,'XL',12,''),(66,5000,250,75,'L',12,''),(67,5000,250,75,'XL',12,''),(68,5500,210,75,'S',12,''),(69,5000,250,80,'M',12,''),(70,5025,275,75,'L',12,'');
...
INSERT INTO `user_access` VALUES (1,'user','123'),(2,'saddam','saddam1');
...
-- Dump completed on 2019-05-27  0:15:48
